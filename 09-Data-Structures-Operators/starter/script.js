...
console.log(gkBayern, fieldPlayersBayern);
console.log(gkDortmund, fieldPlayersDortmund);
...
// 7. The team with the lower odd is more likely to win. Print to the console which team is more likely to win, 
// WITHOUT using an if/else statement or the ternary operator.
team1 < team2 && console.log("Team 1 is more likely to win") || team2 < team1 && console.log("Team 2 is more likely to win");